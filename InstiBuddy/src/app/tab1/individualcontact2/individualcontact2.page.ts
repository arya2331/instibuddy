...
@Component({
  selector: 'app-individualcontact2',
  templateUrl: './individualcontact2.page.html',
  styleUrls: ['./individualcontact2.page.scss'],
})
export class Individualcontact2Page implements OnInit {
  public baseURL;
  public url;
  name: string;
  response: Object;
